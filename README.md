...
This implementation is an unofficial extended version based on the official CA Manager (v0.4.3) provided by [Originator Profile Collaboratice Innovation Partnership (OP-CIP)](https://github.com/originator-profile), with independent experimental features and practical WordPress enhancements.<br/>

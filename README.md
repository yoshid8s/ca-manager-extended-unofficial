...
This implementation is an unofficial extended version based on the official CA Manager (v0.4.3) provided by [Originator Profile Collaborative Innovation Partnership (OP-CIP)](https://github.com/originator-profile), with independent experimental features and practical WordPress enhancements.<br/>
...
The latest version (v0.5.0-x-share) can be downloaded from [Releases](https://github.com/yoshid8s/ca-manager-extension/releases).
...
本実装は、[Originator Profile 技術研究組合(OP-CIP)](https://github.com/originator-profile)提供の公式CA Manager（v0.4.3）をベースに独立して実験的に拡張を行ったもので非公式バージョンです。<br>
...
最新版（v0.5.0-x-share）は [Releases](https://github.com/yoshid8s/ca-manager-extension/releases) からダウンロードできます。
